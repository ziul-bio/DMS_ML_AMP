...
```{r}
#count_matrix <- read.csv(paste(getwd(), "/data/count_matrix_stacked.txt", sep=""), header=FALSE, sep = " ")
#count_matrix <- read.csv("/stor/work/Wilke/luiz/Protegrin-1_Slay_and_ML/results/counts_matrix_stacked.csv")
count_matrix <- read.csv(paste(getwd(), "/results/counts_matrix_stacked.csv", sep=""), header=TRUE, sep = ",")
#count_matrix <- read.csv("/stor/work/Wilke/luiz/Protegrin-1_Slay_and_ML/data/count_matrix.txt", header=FALSE, sep = " ")
